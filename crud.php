...
if(isset($_POST['addproduct']))
{
   ...
   $query="INSERT INTO `products`(`name`, `price`, `address`, `photo`) VALUES ('$_POST[name]','$_POST[price]','$_POST[desc]','$imgpath')";
...
if(isset($_POST['editproduct']))
{
    ...
    if(file_exists($_FILES['image']['tmp_name'])||is_uploaded_file($_FILES['image']['tmp_name']))
    {
        ...
        $update="UPDATE `products` SET `name`='$_POST[name]',`price`='$_POST[price]',`address`='$_POST[desc]',`photo`='$imgpath' WHERE `id`='$_POST[editpid]'";
    }
    else{
        $update="UPDATE `products` SET `name`='$_POST[name]',`price`='$_POST[price]',`address`='$_POST[desc]' WHERE `id`='$_POST[editpid]'";
    }
